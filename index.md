...
<body>
    <div class="container-fluid">
        <div class="row points">
            ...
            <div class="row point">
                <a href="#" onclick=" location.href = '.about-me' " class ="about-me-btn" type="button"><i class="fa fa-times"></i>About me</a>
            </div>
            <div class="row point">
                <a href="#" onclick="location.href = '.education' " type="button">Education</a>
            </div>
            <div class="row point">
                <a href="#" onclick="location.href = '.publication'" class="publication-btn" type="button">Publications</a>
            </div>
            <div class="row point">
            ...
            <div class="col-md-10">
                ...
                <div class="row footer">
                    ...
                    <div class="col-md-6 footer-body">
                        <h4><i>Contact</i></h4>
                        <p>Address: House(476/Baragharia) Ranihati Road, Chapai-Nawabganj sadar, Rajshahi, Bangladesh.</p>
                        <p>E-mail: animesh.pust@gmail.com</p>
                        <p>Phone Number: +8801750894491</p>

                    </div>
                    <div class="col-md-6 footer-body">
                        <h4>Follow me</h4>
                        <a href="https://web.facebook.com/profile.php?id=100007481649229"><img src="images/facebook.png" alt="facebook" class="social img-fluid"></a>
                        <a href="https://www.linkedin.com/in/animesh-karmakar-a331a7126/"><img src="images/linkdin.png" alt="linkdin" class="social"></a>
